...
"Unaccounted Sites" just lists all the vertebrate fauna sites in Neotoma that don't have any corresponding sites in the FaunMap excel sheet that Kitty sent over. 
