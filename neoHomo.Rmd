...
The two maps below (one static, one dynamic) shows the sites they come from, and the table below that shows the sample information on those 28 human samples I found.
