...
The question arises: What would making Neotoma better look like from the perspective of the Seminole Tribe of Florida? We could, for instance, work with the Florida Museum of Natural History to make those connections between datasets and specimens that are currently missing. We could also host workshops for Seminole scientists on how to make use of Neotoma's data. What might the Seminole Nation hope to get out of collaboration with Neotoma?
