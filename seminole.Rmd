...
There are 159 datasets from sites in Florida linked to repositories. For the most part these are vertebrate fauna datasets. It is uncommon for microfossils (like pollen or charcoal) to be held by institutional repositories, which is why many of the datasets from above don't have links to repositories.
...
Neotoma maintains a table of specimen data with potentially detailed information on the part of body, maturity, and sex of the animals being stewarded by repositories. However, this table is rather incomplete because data contributors are not required to upload this information when they submit data to Neotoma. So even though Neotoma knows about 159 datasets linked to repositories (see above), there is no information in the database about the particular specimens that constitute these datasets. 

In fact, the only specimens Neotoma knows about held by the Florida Museum of Natural History are nine deer teeth from a site in Guatemala. 


## Making Neotoma a better database

We've just gone over the current state of the Neotoma database, with respect to its Florida records. As you saw, there's a lot of great data, but the metadata especially is incomplete in many cases. 

We want to make Neotoma better. It is a living database, with an active and growing community of users, contributors, and stewards. Many in this community are eager to do the work that will make Neotoma more comprehensive, more just, more democratic.

The question arises: in what direction would you all like to see the database move? Would you like us to work with the Florida Museum of Natural History, for instance, to make those connections between datasets and specimens that are currently missing? Would you like workshops on how to explore certain kinds of data held by Neotoma? What kinds of collaborations between Neotoma and the Seminole might be productive?

## Staying in Touch

If you have any questions about the information presented here, if you would like to learn more about using Neotoma, or to join our Ethical Open Science Research Coordination Network for Past Global Change Data (EOS RCN), if you have some other kind of collaboration in mind, please reach out to Nick Hoffman at <span style="font-weight:bold;">nicholashoffman@ucmerced.edu</span>, or to the EOS RCN at <span style="font-weight:bold;">EthicalOS.RCN@gmail.com</span>.

Thank you for taking the time to read through this short presentation of Neotoma resources! We hope that this is just the beginning.