...
The question arises: What would making Neotoma better look like from your perspective? Would you like us to work with the Florida Museum of Natural History, for instance, to make those connections between datasets and specimens that are currently missing? Would you like us to host workshops for you on how to explore certain kinds of data held by Neotoma? What kinds of collaborations between Neotoma and the Seminole might be productive?

## Staying in Touch

If you have any questions about the information presented here, if you would like to learn more about using Neotoma, or if you have some other kind of collaboration in mind, please reach out to Nick Hoffman at <span style="font-weight:bold;">nicholashoffman@ucmerced.edu</span>, or to the EOS RCN at <span style="font-weight:bold;">EthicalOS.RCN@gmail.com</span>.
