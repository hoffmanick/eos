...
One problem here is that the repository hosting the specimens according to the specimens table (specimen -> site -> dataset -> repository)is the Florida Museum of Natural History - but according to the repository specimens table there are some discrepancies.
