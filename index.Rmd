...
<ul class="downloads">
          <li><a href="{{site.baseurl}}/florida_pub_authors.csv">Download <strong>Publication Authors</strong></a></li>
          <li><a href="{{site.baseurl}}/florida_site_contacts.csv">Download <strong>Site Contacts</strong></a></li>
        </ul>
